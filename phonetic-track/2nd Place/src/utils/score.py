...
def score_wer(actual, predicted):
    ...
    # jiwer.wer fails when any reference string is empty.
    filtered_refs = []
    filtered_preds = []
    ...
    if not filtered_refs:
        # Fallback for degenerate batches where normalization removes all refs.
        return 1.0

    results = jiwer.wer(filtered_refs, filtered_preds)
    return results
