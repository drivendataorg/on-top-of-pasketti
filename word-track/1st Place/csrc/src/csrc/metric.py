# COPIED FROM childrens-speech-recognition-runtime/metric/score.py
...
def validate_ipa_characters(s: str, raise_error=True) -> bool:
    ...
    if invalid_chars and raise_error:
        raise ValueError("Invalid IPA characters found: " + ", ".join([f"'{c}'" for c in invalid_chars]))
...
if __name__ == "__main__":
    ...
    try:
        ...
        if '"orthographic_text"' in first_line:
            ...
            print("Error: Could not determine metric. JSONL must contain 'orthographic_text' or 'phonetic_text'.")
            sys.exit(1)
