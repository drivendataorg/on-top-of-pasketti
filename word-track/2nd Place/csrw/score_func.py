...
def remove_invalidate_ipa_characters(s):
    s = normalize_ipa(s)
    valid_chars = [c for c in s if c in VALID_IPA_CHARS]
...
def score_wer(actual, predicted, normalize=True):
    """
    ...
    if normalize:
        ...
        results = jiwer.wer(actual, predicted)
    return results
